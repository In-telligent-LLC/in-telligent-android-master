...
(function () {
        ...
        expandProperties:function (val) {
            ...
            for (var i in val) {
                if (val.hasOwnProperty(i)) {
                    ormmaview.getExpandProperties()[i] = val[i];
                }
            }
        },
    ...
    ormma.expand = function (url) {
        broadcastEvent(EVENTS.INFO, 'expanding to ' + url);
        ormmaview.expand(url);
    };
    ...
    ormma.getKeyboard = ormma.getKeyboardState;
    ...
    ormma.addAssets = function (assets) {
        for (var alias in assets) {
            if (assets.hasOwnProperty(alias)) {
    ...
    ormma.response = function (uri, content) {
        broadcastEvent(EVENTS.RESPONSE, uri, content);
    };
