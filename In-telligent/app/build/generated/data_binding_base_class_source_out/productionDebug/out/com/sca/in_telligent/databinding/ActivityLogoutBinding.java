...
public final class ActivityLogoutBinding implements ViewBinding {
  ...
  private ActivityLogoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button testLogoutButton) {
    this.rootView = rootView;
    this.testLogoutButton = testLogoutButton;
  }
  ...
  public static ActivityLogoutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.testLogoutButton;
      Button testLogoutButton = ViewBindings.findChildViewById(rootView, id);
      if (testLogoutButton == null) {
        break missingId;
      }

      return new ActivityLogoutBinding((ConstraintLayout) rootView, testLogoutButton);
    }
