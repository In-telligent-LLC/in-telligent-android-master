...
public final class SignupPasswordPresenter_Factory<V extends SignupPasswordMvpView> implements Factory<SignupPasswordPresenter<V>> {
  ...
  public static <V extends SignupPasswordMvpView> SignupPasswordPresenter_Factory<V> create(
      ...
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<RxPermissions> rxPermissionsProvider, Provider<TwilioUtil> twilioUtilProvider) {
    return new SignupPasswordPresenter_Factory<V>(dataManagerProvider, schedulerProvider, compositeDisposableProvider, rxPermissionsProvider, twilioUtilProvider);
  }
