...
public final class SplashActivity_MembersInjector implements MembersInjector<SplashActivity> {
  ...
  public SplashActivity_MembersInjector(Provider<AudioHelper> audioHelperProvider,
  ...
  public static MembersInjector<SplashActivity> create(Provider<AudioHelper> audioHelperProvider,
      Provider<AudioManager> audioManagerProvider, Provider<DataManager> dataManagerProvider,
      Provider<FusedLocationProviderClient> fusedLocationProviderClientProvider,
      Provider<LocationUtil> locationUtilProvider, Provider<Responder> responderProvider,
      Provider<VideoDownloader> videoDownloaderProvider,
      Provider<SplashMvpPresenter<SplashMvpView>> mPresenterProvider) {
    return new SplashActivity_MembersInjector(audioHelperProvider, audioManagerProvider, dataManagerProvider, fusedLocationProviderClientProvider, locationUtilProvider, responderProvider, videoDownloaderProvider, mPresenterProvider);
  }
  ...
  @InjectedFieldSignature("com.sca.in_telligent.ui.splash.SplashActivity.mPresenter")
  public static void injectMPresenter(SplashActivity instance,
