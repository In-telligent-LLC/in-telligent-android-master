...
public final class MainPresenter_Factory<V extends MainMvpView> implements Factory<MainPresenter<V>> {
  ...
  public MainPresenter_Factory(Provider<DataManager> dataManagerProvider,
  ...
  public MainPresenter<V> get() {
    MainPresenter<V> instance = newInstance(dataManagerProvider.get(), schedulerProvider.get(), compositeDisposableProvider.get());
  ...
  public static <V extends MainMvpView> MainPresenter_Factory<V> create(
      ...
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<RxPermissions> rxPermissionsProvider, Provider<TwilioUtil> twilioUtilProvider) {
    return new MainPresenter_Factory<V>(dataManagerProvider, schedulerProvider, compositeDisposableProvider, rxPermissionsProvider, twilioUtilProvider);
  }

  public static <V extends MainMvpView> MainPresenter<V> newInstance(DataManager dataManager,
