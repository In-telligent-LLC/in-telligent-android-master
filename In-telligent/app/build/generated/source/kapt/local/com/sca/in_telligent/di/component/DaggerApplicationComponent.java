...
import com.sca.in_telligent.receiver.FirebaseBroadcastReceiver_MembersInjector;
...
public final class DaggerApplicationComponent {
  ...
  private static final class ApplicationComponentImpl implements ApplicationComponent {
    ...
    @Override
    public void inject(FirebaseBroadcastReceiver receiver) {
      injectFirebaseBroadcastReceiver(receiver);
    }
    ...
    private MyFirebaseMessagingService injectMyFirebaseMessagingService(
      ...
      MyFirebaseMessagingService_MembersInjector.injectDataManager(instance, provideDataManagerProvider.get());
      MyFirebaseMessagingService_MembersInjector.injectAudioHelper(instance, provideAudioHelperProvider.get());
      MyFirebaseMessagingService_MembersInjector.injectWeatherUtil(instance, provideWeatherUtilProvider.get());
      MyFirebaseMessagingService_MembersInjector.injectResponder(instance, provideResponderProvider.get());
      MyFirebaseMessagingService_MembersInjector.injectLocationUtil(instance, provideLocationUtilProvider.get());
      MyFirebaseMessagingService_MembersInjector.injectGeofenceClient(instance, provideGeofenceClientProvider.get());
      return instance;
    }

    @CanIgnoreReturnValue
    private FirebaseBroadcastReceiver injectFirebaseBroadcastReceiver(
        FirebaseBroadcastReceiver instance) {
      FirebaseBroadcastReceiver_MembersInjector.injectAudioHelper(instance, provideAudioHelperProvider.get());
      return instance;
    }
  }
}
