...
public final class LoginActivity_MembersInjector implements MembersInjector<LoginActivity> {
  ...
  public LoginActivity_MembersInjector(Provider<AudioHelper> audioHelperProvider,
  ...
  public static MembersInjector<LoginActivity> create(Provider<AudioHelper> audioHelperProvider,
      Provider<AudioManager> audioManagerProvider, Provider<DataManager> dataManagerProvider,
      Provider<FusedLocationProviderClient> fusedLocationProviderClientProvider,
      Provider<LocationUtil> locationUtilProvider, Provider<Responder> responderProvider,
      Provider<VideoDownloader> videoDownloaderProvider,
      Provider<LoginMvpPresenter<LoginMvpView>> mPresenterProvider) {
    return new LoginActivity_MembersInjector(audioHelperProvider, audioManagerProvider, dataManagerProvider, fusedLocationProviderClientProvider, locationUtilProvider, responderProvider, videoDownloaderProvider, mPresenterProvider);
  }
  ...
  @InjectedFieldSignature("com.sca.in_telligent.ui.auth.login.LoginActivity.mPresenter")
  public static void injectMPresenter(LoginActivity instance,
