...
public final class ResetPasswordActivity_MembersInjector implements MembersInjector<ResetPasswordActivity> {
  ...
  public ResetPasswordActivity_MembersInjector(Provider<AudioHelper> audioHelperProvider,
      ...
      Provider<ResetPasswordMvpPresenter<ResetPasswordMvpView>> mPresenterProvider) {
  ...
  public static MembersInjector<ResetPasswordActivity> create(
      ...
      Provider<VideoDownloader> videoDownloaderProvider,
      Provider<ResetPasswordMvpPresenter<ResetPasswordMvpView>> mPresenterProvider) {
    return new ResetPasswordActivity_MembersInjector(audioHelperProvider, audioManagerProvider, dataManagerProvider, fusedLocationProviderClientProvider, locationUtilProvider, responderProvider, videoDownloaderProvider, mPresenterProvider);
  }
  ...
  @InjectedFieldSignature("com.sca.in_telligent.ui.auth.reset.ResetPasswordActivity.mPresenter")
  public static void injectMPresenter(ResetPasswordActivity instance,
