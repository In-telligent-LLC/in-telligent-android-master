...
public final class LogoutActivity_MembersInjector implements MembersInjector<LogoutActivity> {
  ...
  private final Provider<LogoutMvpPresenter<LogoutMvpView>> mPresenterProvider;

  public LogoutActivity_MembersInjector(Provider<AudioHelper> audioHelperProvider,
      ...
      Provider<LogoutMvpPresenter<LogoutMvpView>> mPresenterProvider) {
  ...
  public static MembersInjector<LogoutActivity> create(Provider<AudioHelper> audioHelperProvider,
      Provider<AudioManager> audioManagerProvider, Provider<DataManager> dataManagerProvider,
      Provider<FusedLocationProviderClient> fusedLocationProviderClientProvider,
      Provider<LocationUtil> locationUtilProvider, Provider<Responder> responderProvider,
      Provider<VideoDownloader> videoDownloaderProvider,
      Provider<LogoutMvpPresenter<LogoutMvpView>> mPresenterProvider) {
    return new LogoutActivity_MembersInjector(audioHelperProvider, audioManagerProvider, dataManagerProvider, fusedLocationProviderClientProvider, locationUtilProvider, responderProvider, videoDownloaderProvider, mPresenterProvider);
  }
  ...
  @InjectedFieldSignature("com.sca.in_telligent.ui.auth.logout.LogoutActivity.mPresenter")
  public static void injectMPresenter(LogoutActivity instance,
