...
public final class SignupDemographicsActivity_MembersInjector implements MembersInjector<SignupDemographicsActivity> {
  ...
  private final Provider<SignupDemographicsMvpPresenter<SignupDemographicsMvpView>> mPresenterProvider;

  public SignupDemographicsActivity_MembersInjector(Provider<AudioHelper> audioHelperProvider,
      ...
      Provider<SignupDemographicsMvpPresenter<SignupDemographicsMvpView>> mPresenterProvider) {
  ...
  public static MembersInjector<SignupDemographicsActivity> create(
      ...
      Provider<VideoDownloader> videoDownloaderProvider,
      Provider<SignupDemographicsMvpPresenter<SignupDemographicsMvpView>> mPresenterProvider) {
    return new SignupDemographicsActivity_MembersInjector(audioHelperProvider, audioManagerProvider, dataManagerProvider, fusedLocationProviderClientProvider, locationUtilProvider, responderProvider, videoDownloaderProvider, mPresenterProvider);
  }

  @Override
  public void injectMembers(SignupDemographicsActivity instance) {
  ...
  @InjectedFieldSignature("com.sca.in_telligent.ui.auth.register.SignupDemographicsActivity.mPresenter")
  public static void injectMPresenter(SignupDemographicsActivity instance,
