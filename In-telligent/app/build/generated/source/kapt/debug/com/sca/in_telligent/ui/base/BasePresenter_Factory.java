...
public final class BasePresenter_Factory<V extends MvpView> implements Factory<BasePresenter<V>> {
  ...
  public BasePresenter_Factory(Provider<DataManager> dataManagerProvider,
  ...
  public BasePresenter<V> get() {
    BasePresenter<V> instance = newInstance(dataManagerProvider.get(), schedulerProvider.get(), compositeDisposableProvider.get());
  ...
  public static <V extends MvpView> BasePresenter_Factory<V> create(
      ...
      Provider<CompositeDisposable> compositeDisposableProvider,
      Provider<RxPermissions> rxPermissionsProvider, Provider<TwilioUtil> twilioUtilProvider) {
    return new BasePresenter_Factory<V>(dataManagerProvider, schedulerProvider, compositeDisposableProvider, rxPermissionsProvider, twilioUtilProvider);
  }
