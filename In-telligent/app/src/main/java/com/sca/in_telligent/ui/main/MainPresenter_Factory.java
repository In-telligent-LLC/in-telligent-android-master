...
//    private final Provider<RxPermissions> rxPermissionsProvider;
    ...
    public MainPresenter_Factory(Provider<DataManager> provider, Provider<SchedulerProvider> provider2, Provider<CompositeDisposable> provider3, Provider<TwilioUtil> provider4) {
...
//        BasePresenter_MembersInjector.injectRxPermissions(newInstance, this.rxPermissionsProvider.get());
    ...
    public static <V extends MainMvpView> MainPresenter_Factory<V> create(Provider<DataManager> provider, Provider<SchedulerProvider> provider2, Provider<CompositeDisposable> provider3, Provider<TwilioUtil> provider4) {
