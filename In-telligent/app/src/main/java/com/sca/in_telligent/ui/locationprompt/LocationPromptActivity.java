...
/* compiled from: LocationPromptActivity.kt */
...
public final class LocationPromptActivity extends BaseActivity {
    ...
    /* loaded from: C:\Users\BairesDev\Downloads\base-master_decoded_by_apktool\classes3.dex */
    public interface LocationPromptCallBack {
        void onLocationNext();
    }
    ...
    /* renamed from: BuzzBellIcon-FNF3uiM  reason: not valid java name */
    public final void m256BuzzBellIconFNF3uiM(Modifier modifier, final Painter painter, long j, Composer composer, final int i, final int i2) {
        ...
        IconKt.Icon-ww6aTOc(painter, StringResources_androidKt.stringResource((int) R.string.disconnect, startRestartGroup, 0), modifier2, j2, startRestartGroup, 8 | ((i3 << 6) & 896) | ((i3 << 3) & 7168), 0);
    ...
    public final void LocationPromptComposable(Composer composer, final int i) {
        ...
        m256BuzzBellIconFNF3uiM(SizeKt.size-3ABfNKs(Modifier.Companion, Dp.constructor-impl(75)), PainterResources_androidKt.painterResource((int) R.drawable.icon_location, startRestartGroup, 0), ColorResources_androidKt.colorResource((int) R.color.white, startRestartGroup, 0), startRestartGroup, 4166, 0);
        SpacerKt.Spacer(SizeKt.height-3ABfNKs(Modifier.Companion, Dp.constructor-impl(50)), startRestartGroup, 6);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.sca.in_telligent.ui.locationprompt.LocationPromptActivity$LocationPromptComposable$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
    ...
    /* renamed from: SemiBoldText-1DmQkMM  reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m257SemiBoldText1DmQkMM(androidx.compose.ui.Modifier r33, final String r34, int r35, long r36, long r38, final androidx.compose.ui.text.TextStyle r40, int r41, androidx.compose.runtime.Composer r42, final int r43, final int r44) {
        /*
    ...
    /* JADX WARN: Removed duplicated region for block: B:99:0x0145  */
    /* renamed from: BoldText-1DmQkMM  reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m255BoldText1DmQkMM(androidx.compose.ui.Modifier r35, final String r36, int r37, long r38, long r40, final androidx.compose.ui.text.TextStyle r42, int r43, androidx.compose.runtime.Composer r44, final int r45, final int r46) {
        /*
    ...
    public void onRequestPermissionsResult(int i, String[] permissions, int[] grantResults) {
        ...
        if (i == 14) {
            if (grantResults.length == 0) {
                ...
                LocationUtils.setShouldShowStatus((Context) this);
                finish();
            }
        }
    }
