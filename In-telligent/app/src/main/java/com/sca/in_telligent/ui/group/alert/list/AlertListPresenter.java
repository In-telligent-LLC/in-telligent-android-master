...
public class AlertListPresenter<V extends AlertListMvpView> extends BasePresenter<V> implements
        AlertListMvpPresenter<V> {

    @Inject
    public AlertListPresenter(DataManager dataManager,
