...
public final class NotificationDetailPresenter_Factory<V extends NotificationDetailMvpView> implements Factory<NotificationDetailPresenter<V>> {
    ...
    public NotificationDetailPresenter_Factory(Provider<DataManager> provider, Provider<SchedulerProvider> provider2, Provider<CompositeDisposable> provider3, Provider<TwilioUtil> provider4, Provider<RxPermissions> provider5) {
    ...
    public static <V extends NotificationDetailMvpView> NotificationDetailPresenter_Factory<V> create(Provider<DataManager> provider, Provider<SchedulerProvider> provider2, Provider<CompositeDisposable> provider3, Provider<TwilioUtil> provider4, Provider<RxPermissions> provider5) {
        return new NotificationDetailPresenter_Factory<>(provider, provider2, provider3, provider4, provider5);
    }
