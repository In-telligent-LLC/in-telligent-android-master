...
public class VideoResolutionChanger {
  ...
  // TODO: 13.12.2018 Some of the api usages are deprecated, to be updated in later phases. 

  private static final int TIMEOUT_USEC = 10000;

  private static final String OUTPUT_VIDEO_MIME_TYPE = "video/avc";
  private static final int OUTPUT_VIDEO_BIT_RATE = 500 * 1024; //2048 * 1024;
  ...
  private void prepareAndChangeResolution() throws Exception {
    ...
    try {
      ...
      totalDuration = inputFormat.getLong(MediaFormat.KEY_DURATION);
      Log.d("VideoResolutionChanger", "Total duration: " + totalDuration);
...
//                Log.d("VideoResolutionChanger", "Extracted presentationTime: " + presentationTime);
        if (presentationTime > 0) {
          reporter.onProgress((int) ((presentationTime * 100) / totalDuration));
        }
