...
public final class AppTwilioUtil_Factory implements Factory<AppTwilioUtil> {
    ...
    public static AppTwilioUtil_Factory create(Provider<Context> provider, Provider<DataManager> provider2, Provider<SchedulerProvider> provider3, ApplicationModule_ProvideCompositeDisposableFactory provider4, Provider<Responder> provider5, Provider<PreferencesHelper> provider6) {
