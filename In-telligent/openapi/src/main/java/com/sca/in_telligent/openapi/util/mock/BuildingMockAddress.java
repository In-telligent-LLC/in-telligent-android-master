...
public class BuildingMockAddress {
    ...
    private static State state = new State(001, 1, "Missouri", "United States");
    private static Country country = new Country(1, "United States", "US");
    private static City city = new City(1, "Kansas City", state.getId());
